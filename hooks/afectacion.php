<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'afectacion' table. 
	...
	*/
	...
	function afectacion_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function afectacion_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function afectacion_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function afectacion_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function afectacion_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function afectacion_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function afectacion_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function afectacion_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function afectacion_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function afectacion_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function afectacion_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function afectacion_batch_actions(&$args) {
