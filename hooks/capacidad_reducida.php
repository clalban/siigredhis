<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'capacidad_reducida' table. 
	...
	*/
	...
	function capacidad_reducida_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function capacidad_reducida_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function capacidad_reducida_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function capacidad_reducida_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function capacidad_reducida_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function capacidad_reducida_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function capacidad_reducida_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function capacidad_reducida_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function capacidad_reducida_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function capacidad_reducida_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function capacidad_reducida_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function capacidad_reducida_batch_actions(&$args) {
