<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'lesiones' table. 
	...
	*/
	...
	function lesiones_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function lesiones_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function lesiones_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function lesiones_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function lesiones_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function lesiones_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function lesiones_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function lesiones_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function lesiones_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function lesiones_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function lesiones_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function lesiones_batch_actions(&$args) {
