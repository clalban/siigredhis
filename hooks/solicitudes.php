<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'solicitudes' table. 
	...
	*/
	...
	function solicitudes_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function solicitudes_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function solicitudes_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function solicitudes_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function solicitudes_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function solicitudes_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function solicitudes_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function solicitudes_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function solicitudes_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function solicitudes_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function solicitudes_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function solicitudes_batch_actions(&$args) {
