<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'servidor_publico' table. 
	...
	*/
	...
	function servidor_publico_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function servidor_publico_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function servidor_publico_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['VcrSerPub'], $data['VcrTipSerP'], $data['VcrIdProc'], $data['VcrCelSerP'], $data['VcrCorrSerP']
	...
	*/
	...
	function servidor_publico_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function servidor_publico_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['VcrIdSerP'], $data['VcrSerPub'], $data['VcrTipSerP'], $data['VcrIdProc'], $data['VcrCelSerP'], $data['VcrCorrSerP']
	...
	*/
	...
	function servidor_publico_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function servidor_publico_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function servidor_publico_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function servidor_publico_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function servidor_publico_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function servidor_publico_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function servidor_publico_batch_actions(&$args) {
