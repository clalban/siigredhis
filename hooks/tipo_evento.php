<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tipo_evento' table. 
	...
	*/
	...
	function tipo_evento_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_evento_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function tipo_evento_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function tipo_evento_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_evento_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_evento_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_evento_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_evento_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_evento_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_evento_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function tipo_evento_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_evento_batch_actions(&$args) {
