<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'dependencias' table. 
	...
	*/
	...
	function dependencias_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function dependencias_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function dependencias_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function dependencias_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function dependencias_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['VcrId'], $data['VcrIdTra'], $data['VcrTra']
	...
	*/
	...
	function dependencias_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function dependencias_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function dependencias_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function dependencias_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function dependencias_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function dependencias_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function dependencias_batch_actions(&$args) {
