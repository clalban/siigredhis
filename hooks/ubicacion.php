<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'ubicacion' table. 
	...
	*/
	...
	function ubicacion_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function ubicacion_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function ubicacion_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function ubicacion_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function ubicacion_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['VcrIdUbi'], $data['VcrUbi'], $data['VcrDesUbi']
	...
	*/
	...
	function ubicacion_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function ubicacion_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function ubicacion_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function ubicacion_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function ubicacion_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function ubicacion_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function ubicacion_batch_actions(&$args) {
