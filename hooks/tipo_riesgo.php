<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tipo_riesgo' table. 
	...
	*/
	...
	function tipo_riesgo_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_riesgo_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function tipo_riesgo_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function tipo_riesgo_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_riesgo_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_riesgo_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_riesgo_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_riesgo_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_riesgo_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_riesgo_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function tipo_riesgo_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_riesgo_batch_actions(&$args) {
