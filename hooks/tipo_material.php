<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tipo_material' table. 
	...
	*/
	...
	function tipo_material_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_material_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function tipo_material_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function tipo_material_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_material_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_material_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_material_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_material_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_material_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_material_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function tipo_material_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_material_batch_actions(&$args) {
