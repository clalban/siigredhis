<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'fenomenos' table. 
	...
	*/
	...
	function fenomenos_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function fenomenos_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function fenomenos_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function fenomenos_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function fenomenos_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function fenomenos_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function fenomenos_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function fenomenos_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function fenomenos_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function fenomenos_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function fenomenos_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function fenomenos_batch_actions(&$args) {
