<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'motivo_visita' table. 
	...
	*/
	...
	function motivo_visita_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function motivo_visita_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function motivo_visita_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function motivo_visita_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function motivo_visita_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function motivo_visita_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function motivo_visita_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function motivo_visita_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function motivo_visita_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function motivo_visita_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function motivo_visita_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function motivo_visita_batch_actions(&$args) {
