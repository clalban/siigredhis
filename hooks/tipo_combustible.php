<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tipo_combustible' table. 
	...
	*/
	...
	function tipo_combustible_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_combustible_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function tipo_combustible_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function tipo_combustible_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_combustible_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_combustible_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_combustible_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_combustible_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_combustible_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_combustible_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function tipo_combustible_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function tipo_combustible_batch_actions(&$args) {
