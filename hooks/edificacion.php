<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'edificacion' table. 
	...
	*/
	...
	function edificacion_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function edificacion_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function edificacion_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function edificacion_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function edificacion_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function edificacion_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function edificacion_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function edificacion_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function edificacion_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function edificacion_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function edificacion_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function edificacion_batch_actions(&$args) {
