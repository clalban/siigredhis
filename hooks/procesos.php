<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'procesos' table. 
	...
	*/
	...
	function procesos_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function procesos_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function procesos_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function procesos_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function procesos_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['VcrIdProc'], $data['VcrNomProc']
	...
	*/
	...
	function procesos_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function procesos_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function procesos_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function procesos_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function procesos_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function procesos_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function procesos_batch_actions(&$args) {
