<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'caracteristicas_evento' table. 
	...
	*/
	...
	function caracteristicas_evento_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function caracteristicas_evento_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function caracteristicas_evento_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function caracteristicas_evento_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function caracteristicas_evento_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function caracteristicas_evento_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function caracteristicas_evento_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function caracteristicas_evento_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function caracteristicas_evento_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function caracteristicas_evento_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function caracteristicas_evento_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function caracteristicas_evento_batch_actions(&$args) {
