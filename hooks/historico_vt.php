<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'historico_vt' table. 
	...
	*/
	...
	function historico_vt_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function historico_vt_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function historico_vt_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['VcrCodHis'], $data['Vcrano'], $data['VcrIdSerP'], $data['VcrIdSol'], $data['VcrRadSol'], $data['VcrFecSol'], $data['VcrRadRes'], $data['VcrFecRad'], $data['VcrDiaResp'], $data['VcrIdRie'], $data['VcrEntSol'], $data['VcrNomAti'], $data['VcrNoIde'], $data['VcrCel'], $data['VcrCodForm'], $data['VcrFecVis'], $data['VcrDir'], $data['VcrIdBarVe'], $data['VcrIdCom'], $data['VcrIdCorr'], $data['VcrLon'], $data['VcrLat'], $data['VcrIdMot'], $data['VcrIdFen'], $data['VcrIdCar'], $data['VcrAyuHum'], $data['VcrPerHer'], $data['VcrPerFall'], $data['VcrTraCas'], $data['VcrCop'], $data['VcrEstTra'], $data['VcrObsHis'], $data['VcrUbiInf'], $data['VcrResInf'], $data['VcrIdTra1'], $data['VcrRadTra1'], $data['VcrFecTra1'], $data['VcrResTra1'], $data['VcrIdTra2'], $data['VcrRadTra2'], $data['VcrFecTra2'], $data['VcrResTra2'], $data['VcrIdTra3'], $data['VcrRadTra3'], $data['VcrFecTra3'], $data['VcrResTra3'], $data['VcrIdTra4'], $data['VcrRadTra4'], $data['VcrFecTra4'], $data['VcrResTra4'], $data['VcrIdTra5'], $data['VcrRadTra5'], $data['VcrFecTra5'], $data['VcrResTra5'], $data['VcrIdTra6'], $data['VcrRadTra6'], $data['VcrIdTra7'], $data['VcrRadTra7'], $data['VcrIdTra8'], $data['VcrRadTra8']
	...
	*/
	...
	function historico_vt_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function historico_vt_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function historico_vt_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['VcrId'], $data['VcrCodHis'], $data['Vcrano'], $data['VcrIdSerP'], $data['VcrIdSol'], $data['VcrRadSol'], $data['VcrFecSol'], $data['VcrRadRes'], $data['VcrFecRad'], $data['VcrDiaResp'], $data['VcrIdRie'], $data['VcrEntSol'], $data['VcrNomAti'], $data['VcrNoIde'], $data['VcrCel'], $data['VcrCodForm'], $data['VcrFecVis'], $data['VcrDir'], $data['VcrIdBarVe'], $data['VcrIdCom'], $data['VcrIdCorr'], $data['VcrLon'], $data['VcrLat'], $data['VcrIdMot'], $data['VcrIdFen'], $data['VcrIdCar'], $data['VcrAyuHum'], $data['VcrPerHer'], $data['VcrPerFall'], $data['VcrTraCas'], $data['VcrCop'], $data['VcrEstTra'], $data['VcrObsHis'], $data['VcrUbiInf'], $data['VcrResInf'], $data['VcrIdTra1'], $data['VcrRadTra1'], $data['VcrFecTra1'], $data['VcrResTra1'], $data['VcrIdTra2'], $data['VcrRadTra2'], $data['VcrFecTra2'], $data['VcrResTra2'], $data['VcrIdTra3'], $data['VcrRadTra3'], $data['VcrFecTra3'], $data['VcrResTra3'], $data['VcrIdTra4'], $data['VcrRadTra4'], $data['VcrFecTra4'], $data['VcrResTra4'], $data['VcrIdTra5'], $data['VcrRadTra5'], $data['VcrFecTra5'], $data['VcrResTra5'], $data['VcrIdTra6'], $data['VcrRadTra6'], $data['VcrIdTra7'], $data['VcrRadTra7'], $data['VcrIdTra8'], $data['VcrRadTra8']
	...
	*/
	...
	function historico_vt_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function historico_vt_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function historico_vt_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function historico_vt_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function historico_vt_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function historico_vt_batch_actions(&$args) {
